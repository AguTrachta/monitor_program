...
/**
 * @file prom_gauge.h
 * @brief Gauge metric for Prometheus.
 *
 * See https://prometheus.io/docs/concepts/metric_types/#gauge for more details on gauges.
 */
 ...
 *                   literal.
 * @return The constructed prom_gauge_t*.
 *
 * *Example*
 *
 ...
 *        returned on failure.
 *
 * @param self The target prom_gauge_t* to destroy.
 ...
 *
 * @param self The target prom_gauge_t*.
 * @param r_value The value to add to the prom_gauge_t passed as self.
 * @param label_values The label values associated with the metric sample being updated. The number of labels must
 *                     match the value passed to label_key_count in the gauge's constructor. If no label values are
 *                     necessary, pass NULL. Otherwise, it may be convenient to pass this value as a literal.
 * @return A non-zero integer value upon failure.
...
/**
 * @brief Subtract the value from the prom_gauge_t*. A non-zero integer value will be returned on failure.
 *
 * @param self The target prom_gauge_t*.
 * @param r_value The value to subtract from the prom_gauge_t passed as self.
 * @param label_values The label values associated with the metric sample being updated. The number of labels must
 *                     match the value passed to label_key_count in the gauge's constructor. If no label values are
 *                     necessary, pass NULL. Otherwise, it may be convenient to pass this value as a literal.
 * @return A non-zero integer value upon failure.
 ...
 *
 * @param self The target prom_gauge_t*.
 * @param r_value The value to set for the prom_gauge_t passed as self.
 * @param label_values The label values associated with the metric sample being updated. The number of labels must
 *                     match the value passed to label_key_count in the gauge's constructor. If no label values are
 *                     necessary, pass NULL. Otherwise, it may be convenient to pass this value as a literal.
 * @return A non-zero integer value upon failure.
